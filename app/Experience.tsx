            ...
            <div className={styles.experienceOne}>
              <div className={styles.cell}>
                ...
                <p className={styles.jobDescription}>
                  ...
                  causes analyses and implementing solutions in adherence to
                  Quality System regulations. Collaborate with DevOps and other
                  cross-functional teams to deploy software releases, impacting
                  500,000 users. Develop software verification plans for testing
            ...
            <div className={styles.experienceTwo}>
              <div className={styles.cell}>
                ...
                <p className={styles.jobDescription}>
                  ...
                  teaching over 10 courses, including Python and Web
            ...
            <div className={styles.experienceThree}>
              <div className={styles.cell}>
                ...
                <p className={styles.jobDescription}>
                  ...
                  overseeing a group of 20 students in an immersive introduction
                  to Arduino programming. Enhanced students&apos; coding
                  proficiency through effective instruction in C++ programming
                  and Arduino IDE utilization. Guided students in crafting
                  expressive robotics, resulting in the successful development
                  of 10 operational robots.
                </p>
                <div className={styles.skills}>
                  <span>C++</span>
                  <span>Arduino</span>
            ...
            <div className={styles.experienceFour}>
              <div className={styles.cell}>
                ...
                <p className={styles.jobDescription}>
                  ...
                  project using MIT App Inventor, providing guidance to students
                  as they created unique educational games. In addition to
                  teaching programming concepts, I fostered collaboration within
                  groups to collectively design engaging and educational games.
                </p>
                <div className={styles.skills}>
