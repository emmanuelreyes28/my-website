      ...
      <div className={styles.container}>
        ...
        <div className={styles.experienceTwo}>
          <div className={styles.rightCells}>
            ...
            <p className={styles.jobDescription}>
              ...
              students aged 13-17. Collaborated on curriculum design, resulting
              in widespread adoption and the successful completion of 100+
              projects per quarter by 150+ students and instructors.
            </p>
            <div className={styles.skills}>
              <span>Python</span>
        ...
        <div className={styles.experienceThree}>
          <div className={styles.leftCells}>
            ...
            <p className={styles.jobDescription}>
              Educational leader with a focus on coding and robotics, overseeing
              a group of 20 students in an immersive introduction to Arduino
        ...
        <div className={styles.experienceFour}>
          <div className={styles.rightCells}>
            ...
            <p className={styles.jobDescription}>
              ...
              project using MIT App Inventor, providing guidance to students as
              they created unique educational games. In addition to teaching
